...
public class Controller {
    ...
    */
    ...
    public void prePopulation(){
        ...
        studentList.insert(new Patient(11422305, "Mike", "Oscar", "Ontario", 25, 'M', 85, "Estructuras de Datos"));
    ...
    public void addStudent(){
        ...
        while(exit != true){
            ...
            if(studentList.existById(id) == true){
                ...
                studentList.insert(new Patient(id,firstName,middleName,lastName,age,gender,grade,universityCourseName));
