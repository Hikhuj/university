(function() {
    ...
    const getQuery1 = function() {
        fetch('http://localhost:50394/api/ProductosAlfabeticos')
    ...
    const getQuery2 = function() {
        fetch('http://localhost:50394/api/ProveedoresFiltro1')
            .then(response => response.json())
            .then(datos => {
                let dato = JSON.parse(datos);
                let archivo = base64ToArrayBuffer(dato['archivo']);
    ...
    const getQuery3 = function() {
        fetch('http://localhost:50394/api/ProveedoresFiltro2')
            .then(response => response.json())
            .then(datos => {
                let dato = JSON.parse(datos);
                let archivo = base64ToArrayBuffer(dato['archivo']);
    ...
    const getQuery4 = function() {
        fetch('http://localhost:50394/api/Canton')
            .then(response => response.json())
            .then(datos => {
                let dato = JSON.parse(datos);
                let archivo = base64ToArrayBuffer(dato['archivo']);
    ...
    const getQuery5 = function() {
        fetch('http://localhost:50394/api/Pedidos')
            .then(response => response.json())
            .then(datos => {
                let dato = JSON.parse(datos);
                let archivo = base64ToArrayBuffer(dato['archivo']);
    ...
    const getQuery6 = function() {
        fetch('http://localhost:50394/api/ProductoLinea')
            .then(response => response.json())
            .then(datos => {
                let dato = JSON.parse(datos);
                let archivo = base64ToArrayBuffer(dato['archivo']);
